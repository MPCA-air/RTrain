...
Go to — [Install R](https://mpca-air.github.io/RCamp/00-Install.html) — for instructions on installing the latest version of R and RStudio.  

<br>  
  
#### Updates

Go to — [Update R](https://mpca-air.github.io/RTrain/00-Update.html) — if you already have R installed but haven't used it in awhile.  
...
<a href=""><img src="images/day3_sq.png"></a>
...
These workshops dive into more detail on a common data anlaysis or visualization task. 
...
Messy data <i class="fa fa-cogs" aria-hidden="true" style="color: gray;"></i> 
</span>
</a></div>
...
1. Turn messy data into a tidy table.
1. Collapse data spread across many columns.
1. Order plots from highest to lowest.
1. Read in a whole folder of files at once.
1. Clean special characters from column names.
