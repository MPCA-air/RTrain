...
Let's start applying what we've learned to new data. When you're ready to earn Grand Molf status, explore some of your own data to create a summary from scratch. 

<div class="row3" style = "margin-top: 20px;">

<div class="column3"><span style="margin-left: 0;">
<i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> 
__ENSIGN__ 
</span></div> 

<div class="column3"> <span style="margin-left: 0;">
<i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i><i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> 
__COMMODORE__ 
</span></div> 

<div class="column3"> <span style="margin-left: 0;"><i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> <i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> <i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> 
__GRAND MOFF__ 
</span></div>
</div>
