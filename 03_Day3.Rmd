...
Take a look at our __NEW__ scrap data and see if we have the mass of all the items.
...
__Please go do your magic data finding thing."__
...
It took a while, but with a few droid bribes BB8 was able to track down a `Mass conversion table` from his old droid buddies. Our current data shows the total cubic yards for some scrap shipments, but not how much the shipment weighs. 

### Read the mass conversion table {-}
...
### <i class="fa fa-user-astronaut" aria-hidden="true" style="color:#040707;"></i> EXERCISE {-}
