...
<span class = "btn_code_blue"> __DOWNLOAD__  </span></a> —  The Day 1 data files
...
<details><summary class = "btn_code_blue"> __EXPLORE:__ Save a CSV from Excel </summary>
<p>

__Step 1:__ Open an Excel file.
...
You can install it by running the following in your _Console_: `install.packages("ggplot2")`

<br><br><br>

__NOTE:__ You can also install packages from the `Packages` tab in the lower right window of RStudio.
...
Follow along by downloading the __porg__ data from the URL below.

```{r, eval = F}
porgs <- read_csv("https://raw.githubusercontent.com/itep-data/learnR/master/data_examples/porg_data.csv")
