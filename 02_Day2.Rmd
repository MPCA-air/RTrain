...
The _dplyr_ package is our go-to tool for exploring, re-arranging, and summarizing data.  
...
ggplot(mag_endor, aes(day_text, desc(week_month), fill = Result)) +
