...
<div class="column3"><span style="margin-left: 32%;"><i class="fa fa-star" aria-hidden="true" style="color: #f17405;"></i> 
__Day 1__ 
<i class="fa fa-star" aria-hidden="true" style="color: #f17405;"></i></span></div>

<div class="column3"> <span style="margin-left: 32%;><i class="fa fa-star" aria-hidden="true" style="color: #2a5ea9;"></i> 
__Day 2__ 
<i class="fa fa-star" aria-hidden="true" style="color: #2a5ea9;"></i></span></div> 

<div class="column3"> <span style="margin-left: 32%;><i class="fa fa-star" aria-hidden="true" style="color: #fa970c;"></i> 
__Day 3__ 
