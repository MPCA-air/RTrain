...
Create a new data frame that only includes `Retrorockets` and `Sublight drives` that are priced higher than 500 credits. Give the new data frame a detailed name, something like `highend_starship_junk`.
