...
ggplot(mag_endor, aes(x = week_day, y = desc(week_month), fill = Result)) +
...
#### _...I wish I could type the data frame name less often._ {-}

<br>


![](https://d21ii91i3y6o6h.cloudfront.net/gallery_images/from_proof/9302/medium/1447173978/rstudio-hex-pipe-dot-psd.png){style="margin-right: 20px; width: 130px; float: left;"}
...
Here are the functions we've applied to the scrap data so far:
...
Similar to above, use the `%>%` to make the Endor script shorter.
