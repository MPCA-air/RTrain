...
The code below filters the data to only scrap records originating in the `Outskirts` __AND__ sent to `Niima Outpost`.
...
BB8 was able to recover the full scrap data from the notorious Junk Boss Unkar Plutt. Check your folder for the new dataset named `starwars_scrap_jakku_full.csv`. 
