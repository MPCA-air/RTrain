...
Let's launch ourselves into the unknown and use R to make a `Word Cloud`. With a little copy and pasting we can make a fun image out of everyone's name in the class. 

Since you're such a big deal, we're going to be helping you make your name really <span style="font-size: 26px;"> __BIG__ </span> in the word cloud below.
...
#### Congrats rebel droid! <i class="fa fa-android" style="font-size: 44px;"></i>  {-}
...
Let's introduce ourselves and the data we love. Find a partner and learn 3 things about them.
...
- The messiest, weirdest, funniest part of their data
- Something they have to do over and over again

__Hint:__ _Maybe this is something you can automate with R._ 
...
- MPCA R question board (https://github.com/MPCA-air/R-questions) 
- Finding R Help https://itep-r.netlify.com/page/help.html
- R cheatsheet / function cards
...
- When your data will have frequent updates
- When you want to improve a process over time.
...
![](images/install_packages.png){style="width: 500px; height: 200px; margin-left: 10%;"}
