...
## Introductions _(first things first)_ {-}
<hr>
...
> - Messiest/weirdest/funniest part of your data? Or something you have to do over and over again? __Hint!__ _This is something we can automate on the third day._ 
...
> __Well darn, that's not a very impressive price.__
...
<details>
<summary class = "btn_code_green"> _Show hint_ </summary>
<p>
__HINT:__ You will need to use the `c(...)` function and the `%in%` operator.
...
__HINT:__ Ask about the __Most__ or __Least__ of something

<br><br>

<details>
<summary class = "btn_code_blue"> __EXPLORE:__ _What is the __c()__ thing again?_ </summary>
<p>
...
![](images/rey_bb8.jpg){width="270" align="right" style="margin-top: 0px; margin-left: 15px; margin-right: 0px;"}
...
<img src="https://upload.wikimedia.org/wikipedia/en/6/6d/SWFFA.jpg" width="200" style="margin-top: 10px; margin-right: 30px;">
